"""Repository interface for {{EntityName}} - Advanced CRUD."""
...
class {{EntityName}}Repository(ABC):
    """Port for managing {{EntityNameLower}} master data with advanced features"""
    ...
    async def search(
        ...
        """Search {{EntityNamePluralLower}} by term and status with advanced filters"""
