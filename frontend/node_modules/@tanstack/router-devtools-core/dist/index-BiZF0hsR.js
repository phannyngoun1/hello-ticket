...
import { createContext, useContext, createSignal, lazy } from "solid-js";
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-DdHNTjWg.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-CaAQWNvS.js").then((n) => n.c));
...
export {
  ...
  TanStackRouterDevtoolsPanelCore as a,
  useDevtoolsOnClose as u
};
//# sourceMappingURL=index-BiZF0hsR.js.map
