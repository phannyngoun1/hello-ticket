  ...
  mount(el) {
    ...
    const dispose = web.render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = solidJs.lazy(() => Promise.resolve().then(() => require("./FloatingTanStackRouterDevtools-0xtXUOcx.cjs")));
        this.#Component = Devtools;
      }
      return web.createComponent(ShadowDomTargetContext.Provider, {
  ...
  mount(el) {
    ...
    const dispose = web.render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = solidJs.lazy(() => Promise.resolve().then(() => require("./BaseTanStackRouterDevtoolsPanel-CbH9Ihs_.cjs")).then((n) => n.BaseTanStackRouterDevtoolsPanel$1));
        this.#Component = BaseTanStackRouterDevtoolsPanel;
      }
      return web.createComponent(ShadowDomTargetContext.Provider, {
        value: shadowDOMTarget,
        get children() {
          return web.createComponent(DevtoolsOnCloseContext.Provider, {
            value: {
              onCloseClick: () => {
              }
            },
...
//# sourceMappingURL=index-CHaaetqh.cjs.map
