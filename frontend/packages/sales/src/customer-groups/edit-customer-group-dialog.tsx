/**
 * Edit CustomerGroup Dialog
 *
 * Dialog for editing existing customerGroups
 *
 * @author Phanny
 */
...
import type {CustomerGroupTree, UpdateCustomerGroupInput } from "./types";
...
interface EditCustomerGroupDialogProps {
  ...
  onSubmit: (id: string, data: UpdateCustomerGroupInput) => Promise<void>;
  item: CustomerGroupTree | null;
}

export function EditCustomerGroupDialog({
  open,
  onOpenChange,
  onSubmit,
  item,
}: EditCustomerGroupDialogProps) {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const onFormSubmit = async (data: FormData) => {
    ...
    try {
      const input: UpdateCustomerGroupInput = {
        code: data.code,
