/**
 * CustomerGroup Tree Component
 *
 * Displays customerGroups in a hierarchical tree view with expand/collapse
 */
...
import type { CustomerGroupTree } from "./types";
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
...
interface CustomerGroupTreeProps {
  items: CustomerGroupTree[];
  onItemClick?: (item: CustomerGroupTree) => void;
  onAddChild?: (parent: CustomerGroupTree) => void;
  onEdit?: (item: CustomerGroupTree) => void;
  onDelete?: (item: CustomerGroupTree) => void;
