 ...
 *
 * Dialog component for managing customer tags with combobox for selecting existing tags or creating new ones
 *
 * @author Phanny
 */
...
export function CustomerTagsDialog({
  ...
  }, [customer.id, tagService, searchQuery]);
  ...
  const hasChanges = useMemo(() => {
    const initialTags = customer.tags || [];
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[650px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add or remove tags for <span className="font-medium">{customer.name || customer.code}</span>. 
