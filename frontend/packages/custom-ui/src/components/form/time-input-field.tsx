 ...
 *
 * Reusable time input field component that integrates with react-hook-form.
 * Handles time validation and formatting.
 *
 * @author Phanny
 */
 ...
 * Time Input Field Component
 *
 * A reusable time input field that integrates with react-hook-form.
 * Automatically handles validation errors and displays them.
 * The value is stored as a string in HH:mm format.
 */
export function TimeInputField<TFieldValues extends FieldValues = FieldValues>({
  name,
  label,
  placeholder,
  required = false,
