...
import { AttachmentService, FileUpload, uploadService } from "@truths/shared";
import { ConfirmationDialog } from "../confirmation-dialog";

export interface EntityAttachmentsDialogProps {
  open: boolean;
...
export function EntityAttachmentsDialog({
  ...
  }, [entityId, entityType, attachmentService]);
  ...
  const handleFileSelect = useCallback(
    async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      for (const file of files) {
        ...
        try {
          ...
          // Link to entity
          await attachmentService.linkAttachment(entityType, entityId, {
    ...
    [entityId, entityType, attachmentService, loadAttachments]
  );
