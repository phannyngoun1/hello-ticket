 ...
 *
 * Dialog component for managing organizer document attachments
 *
 * @author Phanny
 */
...
export function OrganizerAttachmentsDialog({
  ...
  }, [organizer.id, attachmentService]);
  ...
  const handleFileSelect = useCallback(
    async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      for (const file of files) {
        ...
        try {
          ...
          // Link to organizer
          await attachmentService.linkAttachment("organizer", organizer.id, {
    ...
    [organizer.id, attachmentService, loadAttachments]
  );
      ...
      >
        ...
        <div className="overflow-y-auto min-h-0 space-y-4">
          ...
          <div className="space-y-2 flex-shrink-0 pt-2">
            <label
              htmlFor={`attachments-${organizer.id}`}
