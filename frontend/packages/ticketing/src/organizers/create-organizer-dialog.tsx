/**
 * Create Organizer Dialog Component
 *
 * Full-screen dialog for creating new organizers using the shared form component.
 */
...
import type { CreateOrganizerInput } from "./types";

export interface CreateOrganizerDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (data: CreateOrganizerInput) => Promise<void>;
  title?: string;
  maxWidth?: string;
}
  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        title="Confirm Organizer Creation"
        description={
          pendingFormData ? (
            <p className={cn("mb-3", density.textSizeSmall)}>
              Are you sure you want to create this organizer?
            </p>
          ) : undefined
        }
