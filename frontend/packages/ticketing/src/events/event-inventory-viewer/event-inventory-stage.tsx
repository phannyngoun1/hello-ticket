...
export interface EventInventoryStageProps {
  ...
  onWheel: (e: Konva.KonvaEventObject<WheelEvent>, isSpacePressed: boolean) => void;
  onMouseDown: (e: Konva.KonvaEventObject<MouseEvent>) => void;
  onMouseMove: (e: Konva.KonvaEventObject<MouseEvent>) => void;
  onMouseUp: () => void;
  onMouseLeave: () => void;
  setHoveredSectionId: (id: string | null) => void;
  setHoveredSectionData: (data: {
    section: Section;
    seatCount: number;
    eventSeatCount: number;
  ...
  setHoveredSeatData: (data: { seat: Seat; eventSeat?: EventSeat } | null) => void;
