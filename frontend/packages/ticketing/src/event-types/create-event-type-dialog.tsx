/**
 * Create EventType Dialog Component
 *
 * Full-screen dialog for creating new event-types with form validation
 */
...
import { CreateEventTypeInput } from "./types";
import { useEventTypeService } from "./event-type-provider";

export interface CreateEventTypeDialogProps {
  open: boolean;
...
export function CreateEventTypeDialog({
  ...
  const handleConfirmSubmit = async () => {
    try {
      const createData: CreateEventTypeInput = {
  ...
  return (
    <>
      <FullScreenDialog
        ...
        onClose={handleClose}
        title={t(
          "pages.settings.ticketing.et.createTitle",
          "Create EventType"
        )}
        maxWidth="500px"
        loading={loading}
        ...
        footer={[
          ...
          {
            label: loading
              ? t("pages.settings.ticketing.et.creating", "Creating...")
              : t("pages.settings.ticketing.et.create", "Create EventType"),
            variant: "default",
            type: "submit",
            onClick: (e) => {
              e?.preventDefault();
      ...
      <ConfirmationDialog
        ...
        title={t(
          "pages.settings.ticketing.et.confirmCreateTitle",
          "Confirm EventType Creation"
        )}
        description={
          <>
            <p className={cn("mb-3", density.textSizeSmall)}>
              {t(
                "pages.settings.ticketing.et.confirmCreateDescription",
                "Are you sure you want to create a new event-type?"
              )}
            </p>
          </>
        }
        confirmAction={{label: loading
              ? t("pages.settings.ticketing.et.creating", "Creating...")
              : t(
                  "pages.settings.ticketing.et.confirmCreate",
                  "Confirm & Create"
                ),
