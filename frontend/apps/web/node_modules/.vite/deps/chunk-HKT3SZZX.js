  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-DdHNTjWg-TTJ6SEFB.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-CaAQWNvS-CRCVDIZI.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-HKT3SZZX.js.map
