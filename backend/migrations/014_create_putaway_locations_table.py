...
Description: Creates putaway_locations table for storing planned putaway locations for goods receipt line items
"""
...
async def run_migration():
    ...
    # Read SQL file
    sql_file = Path(__file__).parent / "014_create_putaway_locations_table.sql"
    ...
    async with engine.begin() as conn:
        print("🚀 Running migration 014: Create Putaway Locations Table")
