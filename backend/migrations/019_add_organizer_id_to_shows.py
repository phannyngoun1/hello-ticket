#!/usr/bin/env python3
"""
Database migration script for adding organizer_id to shows table.

This migration adds support for linking shows to organizers.
"""
...
async def run_migration():
    ...
    # Read SQL file
    sql_file = Path(__file__).parent / "019_add_organizer_id_to_shows.sql"
    ...
    async with engine.begin() as conn:
        print("🚀 Running migration 019: Add organizer_id to shows")
        ...
        print("   NOTE: organizer_id column added to shows table")
